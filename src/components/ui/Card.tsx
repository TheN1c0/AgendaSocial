...
export const Card = ({ title, children, padding, noPadding, className = '', ...props }: CardProps) => {
  ...
  return (
    <div
      className={`bg-white dark:bg-[#242424] border-[0.5px] border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden ${className}`}
      {...props}
    >
      {title && (
